        ...
        <div className="bg-black border-2 border-pink-400 shadow-[0_0_30px_rgba(255,20,147,0.6)] mx-auto mb-2 max-w-5xl relative overflow-hidden">
          ...
          <div className="relative flex items-center justify-between px-6 py-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              <a href="/blog" className="px-6 py-3 border border-pink-400 text-pink-400 hover:bg-pink-400 hover:text-black transition-all duration-300 font-mono uppercase tracking-wider text-sm shadow-[0_0_10px_rgba(255,20,147,0.5)] hover:shadow-[0_0_20px_rgba(255,20,147,1)]">
                Blog
              </a>
